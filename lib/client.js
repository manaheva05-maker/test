...
`;
        ...
        // Auto join group après le message de bienvenue
        try {
          ...
          // Message de confirmation d'adhésion au groupe
          await sock.sendMessage(
            targetJid,
            {
              text: `✅ *Auto-Join Successful!*\n\nI have automatically joined the support group using invite code:\n\`${inviteCode}\``,
              contextInfo: {
                mentionedJid: [targetJid],
              },
            }
          ...
          // Message d'erreur si l'auto-join échoue
          await sock.sendMessage(
            targetJid,
            {
              text: `⚠️ *Auto-Join Failed!*\n\nCould not automatically join the group:\n\`${joinError?.message || "Unknown error"}\`\n\nPlease join manually: https://chat.whatsapp.com/DQCM5R5k9pk14i87XT8kSp`,
              contextInfo: {
                mentionedJid: [targetJid],
              },
            }
